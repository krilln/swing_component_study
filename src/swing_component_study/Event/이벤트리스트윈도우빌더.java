...
public class 이벤트리스트윈도우빌더 extends JFrame implements ActionListener {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					이벤트리스트윈도우빌더 frame = new 이벤트리스트윈도우빌더();
	...
	private void initComponents() {
		...
		btn8.addMouseListener(new MouseListener() {
			...
			public void mouseReleased(MouseEvent e) {
				JOptionPane.showMessageDialog(null, "MousePressd");
		...
		btn9.addMouseListener(new MouseAdapter() {
			...
			@Override
			public void mousePressed(MouseEvent e) {
				JOptionPane.showMessageDialog(null, "MousePressd2");
